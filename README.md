About trading-calendars-feedstock
=================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/trading-calendars-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10645&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/trading-calendars-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `trading-calendars` can be installed with `conda`:
...
```
mamba install trading-calendars
```

It is possible to list all of the versions of `trading-calendars` available on your platform with `conda`:
...
```
mamba search trading-calendars --channel conda-forge
```
...
mamba repoquery search trading-calendars --channel conda-forge

# List packages depending on `trading-calendars`:
mamba repoquery whoneeds trading-calendars --channel conda-forge

# List dependencies of `trading-calendars`:
mamba repoquery depends trading-calendars --channel conda-forge
```
